...
```bash
.\.venv\Scripts\python.exe scripts/analyze_images.py <project_path>/images                    # Default: PPT 16:9
.\.venv\Scripts\python.exe scripts/analyze_images.py <project_path>/images --canvas ppt43     # PPT 4:3
.\.venv\Scripts\python.exe scripts/analyze_images.py <project_path>/images --canvas xiaohongshu  # Xiaohongshu
```
