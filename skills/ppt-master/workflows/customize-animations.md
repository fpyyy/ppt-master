...
```bash
.\.venv\Scripts\python.exe skills/ppt-master/scripts/animation_config.py scaffold <project_path>
```

If it already exists:

```bash
.\.venv\Scripts\python.exe skills/ppt-master/scripts/animation_config.py validate <project_path>
```
