...
- Default mode: `edge-tts` is installed (`.\.venv\Scripts\python.exe -m pip install edge-tts`).
...
```bash
.\.venv\Scripts\python.exe skills/ppt-master/scripts/notes_to_audio.py --list-voices --locale <locale>
```

**ElevenLabs backend**:

```bash
.\.venv\Scripts\python.exe skills/ppt-master/scripts/notes_to_audio.py --provider elevenlabs --list-voices
```

**Cloud providers using explicit voice IDs/names**:

```bash
.\.venv\Scripts\python.exe skills/ppt-master/scripts/notes_to_audio.py --provider minimax --list-voices
.\.venv\Scripts\python.exe skills/ppt-master/scripts/notes_to_audio.py --provider qwen --list-voices
.\.venv\Scripts\python.exe skills/ppt-master/scripts/notes_to_audio.py --provider cosyvoice --list-voices
```
...
.\.venv\Scripts\python.exe skills/ppt-master/scripts/notes_to_audio.py <project_path> \
...
- (If skipped embedding) one-line hint on how to embed later: `.\.venv\Scripts\python.exe skills/ppt-master/scripts/svg_to_pptx.py <project_path> --recorded-narration audio`.
